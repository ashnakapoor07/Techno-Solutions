        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="employeeregister.aspx">Add Employee</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="updatesalary.aspx">Update Salary</a></li>
			...
			<li><a href="#">Important Notes</a></li>
                        <li><a href="#">Organize Meeting</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">
...
<section id="main-content">
   <section class="wrapper">
            <div class="main body" style="text-align:left"> </div>
  </section>
</section>
