<%@ Page Title="" Language="C#" MasterPageFile="~/web/MasterPage.master" AutoEventWireup="true" CodeFile="salarystatement.aspx.cs" Inherits="web_salarystatement" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <form id="form1" runat="server">
    <div>
    
        <asp:Label ID="Label1" runat="server" Text="Salary Statement" Font-Bold="True" Font-Size="XX-Large" Font-Italic="True"></asp:Label>
        <br />
        <br />
        <br />
&nbsp;<asp:Label ID="Label2" runat="server" Text="Employee ID" Font-Bold="True" Font-Size="Large" Font-Italic="False"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
